...
insert into `sys_resource`(`id`, `parent_id`, `parent_ids`, weight, `name`, `identity`, `url`, `enabled`)
  values (1, 0, '0/', 1, '资源', '', '', 1);
/** 采购资源 **/
insert into `sys_resource`(`id`, `parent_id`, `parent_ids`, weight, `name`, `identity`, `url`, `enabled`,`icon`)
