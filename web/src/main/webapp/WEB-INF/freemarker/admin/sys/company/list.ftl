...
jQuery(function($) {
    ...
    jQuery(grid_selector).jqGrid({
        //direction: "rtl",
        url:$path_base+'/admin/sys/company/company/list',
        datatype: "json",
        mtype: 'GET',
        //data: grid_data,
        //datatype: "local",
        ...
        colModel:[
            ...
            {name:'trade_code_id',index:'tradeCodeId', width:60, editable: true},
            {name:'userCount',index:'userCount', width:60, editable: false},
            {name:'site',index:'site', width:100, editable: true,editoptions:{size:"20",maxlength:"50"}},
            ...
            {name:'expireTime',index:'edate',width:90, editable:false,sorttype:"date", formatter:dateFormatter, unformat: pickDate},
            {name:'modifyTime',index:'mdate',width:90, editable:false,sorttype:"date", formatter:dateFormatter, unformat: pickDate},
            {name:'status',index:'status', width:50, editable: true, edittype:"select",  editoptions:{value:"0:正常;1:禁用"}, formatter:statusFormatter}
