...
<head>
    ...
    <link rel="stylesheet" href="${contextPath}/assets/css/bootstrap-modal.css" />
    <link rel="stylesheet" href="${contextPath}/assets/css/bootstrap-modal-bs3patch.css" />

    <link rel="stylesheet" href="${contextPath}/assets/css/zTreeStyle/zTreeStyle.css" type="text/css">
    <!--[if lte IE 8]>
